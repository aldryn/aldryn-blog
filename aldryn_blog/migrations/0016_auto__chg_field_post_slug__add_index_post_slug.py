...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'aldryn_blog_post', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))
        # Adding index on 'Post', fields ['slug']
        db.create_index(u'aldryn_blog_post', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['slug']
        db.delete_index(u'aldryn_blog_post', ['slug'])


        # Changing field 'Post.slug'
        db.alter_column(u'aldryn_blog_post', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
