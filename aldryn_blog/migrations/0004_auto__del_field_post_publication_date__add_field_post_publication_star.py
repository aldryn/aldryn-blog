...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'aldryn_blog_post', 'publication_date')

        # Adding field 'Post.publication_start'
        db.add_column('aldryn_blog_post', 'publication_start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Post.publication_end'
        db.add_column('aldryn_blog_post', 'publication_end',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'aldryn_blog_post', 'publication_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)

        # Deleting field 'Post.publication_start'
        db.delete_column('aldryn_blog_post', 'publication_start')

        # Deleting field 'Post.publication_end'
        db.delete_column('aldryn_blog_post', 'publication_end')
